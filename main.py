...
def handler(event):
    ...
    if person_name_val:
        person_name = person_name_val[0]
    else:
        person_name = None

    print(f"{company_name}, {company_phone}, {position_value}")
    print(f"{doc_type}, {description}, {data_value},  {word}")
    print(f"{place_value}")
